...
export const metadata: Metadata = {
  ...
  description:
    "Protect every lead. Missed-call text-back, intake, owner alerts, Google review SMS, and a shop dashboard. Nothing slips through the cracks. $999 from Intent Revenue.",
