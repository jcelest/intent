...
export const SEO_TITLE_DEFAULT = `${SITE_NAME} | Revenue Growth for Contractors & Trades`;

/** Meta description — includes primary keyword, ~155–160 chars */
export const DEFAULT_DESCRIPTION =
  "We map and grow revenue for HVAC, plumbing, roofing & home services—custom software, exceptional organic search growth, paid ads & content. Phone-first trades. Florida & nationwide.";
