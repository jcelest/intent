...
const GOLD_CARD =
  "border-2 border-amber-400/50 bg-gradient-to-br from-amber-500/[0.14] via-amber-600/[0.08] to-card shadow-[0_0_48px_rgba(217,169,65,0.2)] hover:border-amber-300/70 hover:shadow-[0_0_56px_rgba(217,169,65,0.28)]";
